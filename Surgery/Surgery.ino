...
//
//    *** THIS IS THE Surgery/PACU Version
//
...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x0F, 0x9C, 0xFB };
...
//    Serial.println("Pin 19 is High");
  ...
  if (needTrashPickedUpButtonStateA == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[2], locations[17], subjects[0], bodies[0] ))
    {
  ...
  else  if (trashHasBeenPickedUpButtonStateA == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[2], locations[17], subjects[1], bodies[1] ))
    {
      digitalWrite(dirtyUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
      delay(WAIT);
      digitalWrite(dirtyUtilityRedA, HIGH); // If the sendEmail() Function returns 1
  ...
  if (needLaundryPickedUpButtonStateA == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[3], locations[17], subjects[2], bodies[2] ))
    {
      digitalWrite(dirtyUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
      delay(WAIT);
      digitalWrite(dirtyUtilityRedA, HIGH); // If the sendEmail() Function returns 1
  ...
  else if (laundryHasBeenPickedUpButtonStateA == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[4], locations[17], subjects[3], bodies[3] ))
    {
      digitalWrite(dirtyUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
      delay(WAIT);
      digitalWrite(dirtyUtilityRedA, HIGH); // If the sendEmail() Function returns 1
...
/*
  if (needFreshLinensButtonStateA == HIGH)
  {
    ...
    if (cleanUtilityErrorStatus = sendEmail(recipients[5], locations[20], subjects[4], bodies[4] ))
    {
  ...
  if (freshLinensDeliveredButtonStateA == HIGH)
  {
    ...
    if (cleanUtilityErrorStatus = sendEmail(recipients[6], locations[20], subjects[5], bodies[5] ))
    {
      digitalWrite(cleanUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
      delay(WAIT);
      digitalWrite(cleanUtilityRedA, HIGH); // If the sendEmail() Function returns 1
