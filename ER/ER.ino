...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x0F, 0x9C, 0x85 };
...
String locations[] = {"ICU_Pod_A", "ICU_Pod_B", "ICU_Pod_C", "3_East_Pod_A", "3_East_Pod_B", "3_East_Pod_C", "4_East_Pod_A", "4_East_Pod_B",
                      ...
                      "ED_Clean_Supply", "MEC", "Outpatient_Infusion", "Radiology", "Wound_Care", "Cardiology"
                     };
...
//    Serial.println("Pin 19 is High");
  ...
  if (needTrashPickedUpButtonStateA == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[2], locations[19], subjects[0], bodies[0] ))
    {
  ...
  else  if (trashHasBeenPickedUpButtonStateA == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[2], locations[19], subjects[1], bodies[1] ))
    {
      digitalWrite(dirtyUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
      delay(WAIT);
      digitalWrite(dirtyUtilityRedA, HIGH); // If the sendEmail() Function returns 1
  ...
  if (needLaundryPickedUpButtonStateA == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[3], locations[19], subjects[2], bodies[2] ))
    {
      digitalWrite(dirtyUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
      delay(WAIT);
      digitalWrite(dirtyUtilityRedA, HIGH); // If the sendEmail() Function returns 1
  ...
  else if (laundryHasBeenPickedUpButtonStateA == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[4], locations[19], subjects[3], bodies[3] ))
    {
      digitalWrite(dirtyUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
      delay(WAIT);
      digitalWrite(dirtyUtilityRedA, HIGH); // If the sendEmail() Function returns 1
  ...
  if (needTrashPickedUpButtonStateB == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[2], locations[18], subjects[0], bodies[0] ))
    {
  ...
  else  if (trashHasBeenPickedUpButtonStateB == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[2], locations[18], subjects[1], bodies[1] ))
    {
      digitalWrite(dirtyUtilityGreenB, LOW); //Turn the GREEN led off to indicate end of sending;
      delay(WAIT);
      digitalWrite(dirtyUtilityRedB, HIGH); // If the sendEmail() Function returns 1
  ...
  if (needLaundryPickedUpButtonStateB == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[3], locations[18], subjects[2], bodies[2] ))
    {
      digitalWrite(dirtyUtilityGreenB, LOW); //Turn the GREEN led off to indicate end of sending;
      delay(WAIT);
      digitalWrite(dirtyUtilityRedB, HIGH); // If the sendEmail() Function returns 1
  ...
  else if (laundryHasBeenPickedUpButtonStateB == HIGH)
  {
    ...
    if (dirtyUtilityErrorStatus = sendEmail(recipients[4], locations[18], subjects[3], bodies[3] ))
    {
      digitalWrite(dirtyUtilityGreenB, LOW); //Turn the GREEN led off to indicate end of sending;
      delay(WAIT);
      digitalWrite(dirtyUtilityRedB, HIGH); // If the sendEmail() Function returns 1
...
/*
  if (needFreshLinensButtonStateB == HIGH)
  {
    ...
    if (cleanUtilityErrorStatus = sendEmail(recipients[6], locations[1], subjects[4], bodies[4] ))
    {
...
//Print IP to the display
  ...
  display.setTextColor(WHITE);
  display.setCursor(0,0);
  display.println("Emergency Department\n");
