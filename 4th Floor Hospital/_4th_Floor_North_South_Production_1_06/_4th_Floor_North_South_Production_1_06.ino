...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x0F, 0x9D, 0x3F };
...
{
  Serial.begin(115200);
  Serial.println("4th FLOOR HOSPITAL\n");
...
*/  
    ...
    if (needTrashPickedUpButtonStateA == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (dirtyUtilityErrorStatus = sendEmail(recipients[2], locations[12], subjects[0], bodies[0] ))
      { 
  ...
  else  if (trashHasBeenPickedUpButtonStateA == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (dirtyUtilityErrorStatus = sendEmail(recipients[2], locations[12], subjects[1], bodies[1] ))
      { 
        digitalWrite(dirtyUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
        delay(WAIT);
        digitalWrite(dirtyUtilityRedA, HIGH); // If the sendEmail() Function returns 1 
   ...
   if (needLaundryPickedUpButtonStateA == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (dirtyUtilityErrorStatus = sendEmail(recipients[3], locations[12], subjects[2], bodies[2] ))
      { 
        digitalWrite(dirtyUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
        delay(WAIT);
        digitalWrite(dirtyUtilityRedA, HIGH); // If the sendEmail() Function returns 1 
  ...
  else if (laundryHasBeenPickedUpButtonStateA == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (dirtyUtilityErrorStatus = sendEmail(recipients[4], locations[12], subjects[3], bodies[3] ))
      { 
        digitalWrite(dirtyUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
        delay(WAIT);
        digitalWrite(dirtyUtilityRedA, HIGH); // If the sendEmail() Function returns 1 
   ...
   if (needFreshLinensButtonStateA == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (cleanUtilityErrorStatus = sendEmail(recipients[5], locations[12], subjects[4], bodies[4] ))
      { 
   ...
   if (freshLinensDeliveredButtonStateA == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (cleanUtilityErrorStatus = sendEmail(recipients[6], locations[12], subjects[5], bodies[5] ))
      { 
        digitalWrite(cleanUtilityGreenA, LOW); //Turn the GREEN led off to indicate end of sending;
        delay(WAIT);
        digitalWrite(cleanUtilityRedA, HIGH); // If the sendEmail() Function returns 1 
    ...
    if (needTrashPickedUpButtonStateB == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (dirtyUtilityErrorStatus = sendEmail(recipients[2], locations[13], subjects[0], bodies[0] ))
      { 
  ...
  else  if (trashHasBeenPickedUpButtonStateB == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (dirtyUtilityErrorStatus = sendEmail(recipients[2], locations[13], subjects[1], bodies[1] ))
      { 
        digitalWrite(dirtyUtilityGreenB, LOW); //Turn the GREEN led off to indicate end of sending;
        delay(WAIT);
        digitalWrite(dirtyUtilityRedB, HIGH); // If the sendEmail() Function returns 1 
   ...
   if (needLaundryPickedUpButtonStateB == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (dirtyUtilityErrorStatus = sendEmail(recipients[3], locations[13], subjects[2], bodies[2] ))
      { 
        digitalWrite(dirtyUtilityGreenB, LOW); //Turn the GREEN led off to indicate end of sending;
        delay(WAIT);
        digitalWrite(dirtyUtilityRedB, HIGH); // If the sendEmail() Function returns 1 
  ...
  else if (laundryHasBeenPickedUpButtonStateB == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (dirtyUtilityErrorStatus = sendEmail(recipients[4], locations[13], subjects[3], bodies[3] ))
      { 
        digitalWrite(dirtyUtilityGreenB, LOW); //Turn the GREEN led off to indicate end of sending;
        delay(WAIT);
        digitalWrite(dirtyUtilityRedB, HIGH); // If the sendEmail() Function returns 1 
   ...
   if (needFreshLinensButtonStateB == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (cleanUtilityErrorStatus = sendEmail(recipients[5], locations[13], subjects[4], bodies[4] ))
      { 
   ...
   if (freshLinensDeliveredButtonStateB == HIGH)
  {
    Serial.println("Trying to Send Email");
      ...
      if (cleanUtilityErrorStatus = sendEmail(recipients[6], locations[13], subjects[5], bodies[5] ))
      { 
        digitalWrite(cleanUtilityGreenB, LOW); //Turn the GREEN led off to indicate end of sending;
        delay(WAIT);
        digitalWrite(cleanUtilityRedB, HIGH); // If the sendEmail() Function returns 1 
